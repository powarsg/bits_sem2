...
def extract_articles_from_csv(file_storage, max_rows=MAX_ARTICLES_PER_REQUEST):
    ...
    try:
        if upload and upload.filename:
            ...
            if filename.endswith(".csv"):
                ...
                articles = (blocks if len(blocks) > 1 else [content.strip()])[:MAX_ARTICLES_PER_REQUEST]
            else:
