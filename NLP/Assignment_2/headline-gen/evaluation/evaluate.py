...
def main():
    ...
    ap.add_argument(
        ...
        type=int,
        default=0,
        help="Number of test rows to evaluate; 0 evaluates the complete test split.",
    )
    args = ap.parse_args()
    ...
    summary["test_csv"] = str(Path(args.test_csv).resolve())
